...
file: mio.py
description: this file will demonstrate utility procedure when the stdout is redirected
mio: module, (contains functions capture_output, restore_output, print_file, and clear_file)
this file demonstrate how to capture/redirect the output to a file and how to restore the real __stdout__ 
'''
...
def restore_output():
    """restore_output(): restore the standard output back to the default (also closes the capture file)"""
    global _file_object
